    ...
    async function handleProceedToPayment() {
        ...
        for (const seatId of selectedSeatIds) {
            try {
                ...
                // 409 (already locked) or any other failure - treat as "couldn't secure this seat"
                failedSeatIds.push(seatId)
            }
        }

        // Always reconcile local selection to only what we actually secured
        setSelectedSeatIds(lockedSeatIds)
